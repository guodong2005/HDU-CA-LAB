...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , mti{vlSymsp->TOP.mti}
    , sei{vlSymsp->TOP.sei}
    , inst_sram_en{vlSymsp->TOP.inst_sram_en}
    , inst_sram_wen{vlSymsp->TOP.inst_sram_wen}
    , data_sram_en{vlSymsp->TOP.data_sram_en}
    , data_sram_wen{vlSymsp->TOP.data_sram_wen}
    , debug_commit{vlSymsp->TOP.debug_commit}
    , debug_rf_wnum{vlSymsp->TOP.debug_rf_wnum}
    ...
    , debug_rf_wdata{vlSymsp->TOP.debug_rf_wdata}
    , rootp{&(vlSymsp->TOP)}
{
