...
struct nscscc_sram_ref {
  ...
  nscscc_sram_ref(nscscc_sram_ptr &ptr)
      : inst_sram_en(*(ptr.inst_sram_en)), inst_sram_wen(*(ptr.inst_sram_wen)),
        inst_sram_addr(*(ptr.inst_sram_addr)),
        inst_sram_wdata(*(ptr.inst_sram_wdata)),
        inst_sram_rdata(*(ptr.inst_sram_rdata)),
        data_sram_en(*(ptr.data_sram_en)), data_sram_wen(*(ptr.data_sram_wen)),
...
nscscc_sram_ref::nscscc_sram_ref(nscscc_sram &sram)
    : inst_sram_en(sram.inst_sram_en), inst_sram_wen(sram.inst_sram_wen),
      inst_sram_addr(sram.inst_sram_addr),
      inst_sram_wdata(sram.inst_sram_wdata),
      inst_sram_rdata(sram.inst_sram_rdata), data_sram_en(sram.data_sram_en),
      data_sram_wen(sram.data_sram_wen), data_sram_addr(sram.data_sram_addr),
