...
class Core extends Module {
  ...
  val scalarLegalFunct = Mux(idOpcode === "b0001111".U, idFunct3===0.U || idFunct3===1.U, Mux(idOpcode === "b1110011".U, ifid.instr === "h00100073".U, Mux(idOpcode === "b0010011".U, idFunct3 <= 7.U && (idFunct3 =/= 1.U || idFunct7 === 0.U) && (idFunct3 =/= 5.U || idFunct7 === 0.U || idFunct7 === 32.U), Mux(idOpcode === "b0110011".U, (idFunct7 === 0.U || idFunct7 === 1.U || (idFunct7 === 32.U && (idFunct3 === 0.U || idFunct3 === 5.U))), Mux(idOpcode === "b0000011".U, idFunct3===0.U||idFunct3===1.U||idFunct3===2.U||idFunct3===4.U||idFunct3===5.U, Mux(idOpcode === "b0100011".U, idFunct3<=2.U, Mux(idOpcode === "b1100011".U, idFunct3===0.U||idFunct3===1.U||idFunct3===4.U||idFunct3===5.U||idFunct3===6.U||idFunct3===7.U, Mux(idOpcode === "b1100111".U, idFunct3===0.U, true.B))))))))
