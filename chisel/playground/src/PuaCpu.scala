...
class core_top extends Module {
  val io = IO(new Bundle {
    ...
    val debug_rf_wnum = Output(UInt(5.W)); val debug_rf_wdata = Output(UInt(32.W)); val debug_rf_wen = Output(Bool()); val halted = Output(Bool())
  })
  ...
  io.debug_rf_wnum := core.io.debug_rd; io.debug_rf_wdata := core.io.debug_wdata; io.debug_rf_wen := core.io.debug_wen; io.halted := core.io.halted
}
